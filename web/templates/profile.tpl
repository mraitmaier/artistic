...
<div class="container-fluid" id="view-user-table-div">
    ...
    <div class="row">
        <div class="col-md-4">
            <a type="button" class="btn btn-primary" onclick="return rerouteUsingGet('userprofile', 'modify', {{.Id}});">
            Modify Profile</a>
            <a type="button" class="btn btn-danger" onclick="return rerouteUsingGet('userprofile', 'changepwd', {{.Id}});">
            Change Password </a>
        </div>
    </div>
</div> <!-- container-fluid -->
    ...
    <form class="form-vertical" role="form" method="post" id="user-modify-form">
        ...
        <div class="form-group">
            <div class="col-md-4">
                ...
                <button class="btn btn-danger" type="button" onclick="return rerouteUsingGet('userprofile', 'changepwd', {{.Id}});"
...
<div class="container-fluid" id="change-pwd-form-div">
    <form class="form-vertical" role="form" method="post" onsubmit="validatePasswordChange();" id="change-pwd-form"> 
        <fieldset>
        ...
        <div class="form-group">
            <div class="col-md-4">
                <button class="btn btn-primary" type="button" id="pwd-submit"
                    onclick="return postForm('change-pwd-form', createURL('changepwd', 'userprofile', {{.Id}}));">
