...
<head>
    ...
    <title>Artistic - Handle Articles</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10" id="data-list">
                <h1 id="data-list-header">Articles</h1>

    {{if ne $role "guest"}}
                <div id="new-article-btn">
...
<div class="modal fade" id="removeArticleModal" tabindex="-1" role="dialog" aria-labelledby="removeArticleModalLabel">
...
<div class="modal-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <h3 class="modal-title col-sm-8" id="removeArticleModalLabel">Remove Article</h3>
    ...
    <div class="modal-body">
    <p> Would you really like to remove the article '<span id="removename"></span>'?</p>
    <form method="post" id="remove_article_form">
