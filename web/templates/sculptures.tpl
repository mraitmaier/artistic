...
<head>
    ...
    <title>Artistic - Handle Sculptures</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            {{if .Sculptures}}
                <table class="table table-striped table-hover small" id="sculpture-list-table">
                ...
                <tfoot>
                    <tr class="bg-primary">
                    <td colspan="8"> 
                        <strong> {{.Num}} {{if eq .Num 1}} sculpture {{else}} sculptures {{end}} found. </strong> 
                    </td>
                    </tr>
                </tfoot>
                  ...
                  <tr id="sculpture-row-{{$cnt}}">
				    ...
				    <td>
  						<span data-toggle="tooltip" data-placement="up" title="View details">
                            <a data-toggle="modal" data-target="#viewSculptureModal"
                       ...
                       <span data-toggle="tooltip" data-placement="up" title="Remove"> 
                            <a data-toggle="modal" data-target="#removeSculptureModal"
                                       data-id="{{$element.Id.Hex}}"  
                                       data-title="{{$element.Work.Title}}">
    ...
    $('#modifySculptureModal').on('show.bs.modal', function (event) {
        ...
        // binding library or other methods instead.
        var modal = $(this)
        modal.find('.modal-title').text('Modify Sculpture "' + title + '" Details');
...
// Handle the removals using modal pop-up 
   $('#removeSculptureModal').on('show.bs.modal', function(event) {
        ...
        var url = '/sculpture/' + id + '/delete';
        $('#removebtn').on('click', function(e) { 
            postForm('remove_sculpture_form', url); 
            $('#removeSculptureModal').modal('hide');
        });
   });

    // This should post a form to modify sculpture
    var modifySculpture = function(form_id, id) {
...
{{define "add_sculpture_modal"}}
<div class="modal fade" id="addSculptureModal" tabindex="-1" role="dialog" aria-labelledby="addSculptureModalLabel">
...
<div class="modal-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <h3 class="modal-title col-sm-8" id="addSculptureModalLabel">Add a New Sculpture</h3>
            <button type="button" class="btn btn-primary btn-sm col-sm-2" 
                    onclick="postForm('add-sculpture-form', '/sculpture'); $('#addSculptureModal').modal('hide');"> Add </button>
    ...
    <form class="form-horizontal" role="form" method="post" id="add-sculpture-form">
    <fieldset>

        <div class="form-group form-group-sm has-success">
            <label for="title" class="col-sm-3 control-label">Title</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" id="title" name="title" placeholder="Sculpture title" required autofocus />
            </div>
        </div> <!-- form-group -->
...
{{define "view_sculpture_modal"}}
<div class="modal fade" id="viewSculptureModal" tabindex="-1" role="dialog" aria-lebeleledby="ViewSculptureModalLabel">
<div class="modal-dialog modal-lg">
<div class="modal-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <h3 class="modal-title col-md-10" id="viewSculptureModalLabel"></h3>
    ...
    <div class="modal-body">
        <div class="container-fluid" id="view-sculpture-table-div">
...
{{define "modify_sculpture_modal"}}
<div class="modal fade" id="modifySculptureModal" tabindex="-1" role="dialog" aria-lebeleledby="modifySculptureModalLabel">
<div class="modal-dialog modal-lg">
<div class="modal-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <h3 class="modal-title col-md-8" id="modifySculptureModalLabel">Empty Sculpture Details</h3>
             <button type="button" class="btn btn-primary btn-sm col-sm-2" 
                     onclick="modifySculpture('modify-sculpture-form',$('#hexid').val());$('#modifySculptureModal').modal('hide');">
                     Modify
             </button>
    ...
    <div class="container-fluid">
        ...
        <form id="modify-sculpture-form" class="form-horizontal">
        ...
        <fieldset>
            ...
            <div class="form-group form-group-sm has-success">
                <label for="title" class="col-sm-3 control-label">Title</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="title" name="title" placeholder="Sculpture title" required />
                </div>
            </div> <!-- form-group -->
...
<div class="modal fade" id="removeSculptureModal" tabindex="-1" role="dialog" aria-labelledby="removeSculptureModalLabel">
...
<div class="modal-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <h3 class="modal-title col-sm-8" id="removeSculptureModalLabel">Remove Sculpture</h3>
    ...
    <div class="modal-body">
    <p> Would you really like to remove the sculpture '<span id="removename"></span>'?</p>
    <form method="post" id="remove_sculpture_form">
