...
// The sculptors page handler
func sculptorsHandler(aa *ArtisticApp) http.Handler {
    ...
    //}{ user, cmd }
		...
		// render the page
		err = aa.WebInfo.templates.ExecuteTemplate(w, "sculptors", &web)
        if err != nil {
			log.Error("Cannot render the 'sculptors' page.")
		}
...
// The architects page handler
func architectsHandler(aa *ArtisticApp) http.Handler {
    ...
    //}{ user, cmd }
		...
		// render the page
		err = aa.WebInfo.templates.ExecuteTemplate(w, "architects", &web)
        if err != nil {
			log.Error("Cannot render the 'architects' page.")
		}
...
// The printmakers page handler
func printmakersHandler(aa *ArtisticApp) http.Handler {
    ...
    //}{ user, cmd }
		...
		// render the page
		err = aa.WebInfo.templates.ExecuteTemplate(w, "printmakers", &web)
        if err != nil {
			log.Error("Cannot render the 'printmakers' page.")
		}
...
// The ceramicists page handler
func ceramicistsHandler(aa *ArtisticApp) http.Handler {
    ...
    //}{ user, cmd }
		...
		// render the page
		err = aa.WebInfo.templates.ExecuteTemplate(w, "ceramicists", &web)
        if err != nil {
			log.Error("Cannot render the 'ceramicists' page.")
		}
